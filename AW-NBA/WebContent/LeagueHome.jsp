...
<body>
				...
				<div class="navbar-header">
					<form action="ViewLeague?id=<%=league.getId() %>" method="POST">
						<div class = "navbar-brand">
							<button type="submit" class="btn btn-link btn-lg">Vista de Liga</button>
						</div>
					</form></p>
				</div>
			</div>
        ...
        como al resto de vistas -->
			<div id="navbar" class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					...
					<li class="active"><p><form action="ViewLeague?id=<%=league.getId() %>" method="POST">
					<div class = "button">
						<button type="submit" class="btn btn-link btn-sm">League: <%=league.getName() %></button>
					</div>
					</form></p>	</li>
					...
					<li><p><form action="MarketHomeServlet" method="POST">
						<div class = "button">
							<button type="submit" class="btn btn-link btn-sm">Market</button>
						</div>
					</form></p>	</li>
					<% } else if (status.getPhase() == 3) { %>
					<li><p><form action="SummaryHomeServlet" method="POST">
						<div class = "button">
	...
	<!-- src="data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==" -->
			...
			<div class="col-md-12">
				...
				<p><form action="AdvanceLeagueStatus" method="POST">
					<div class = "button">
						<button type="submit" class="btn btn-warning btn-lg">Cambiar estado de Liga</button>
					</div>		
				</form></p>
				<% } %>
