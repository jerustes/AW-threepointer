	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<div class="navbar-header">
					<a class="navbar-brand" href="AdminHomeServlet">Vista Administrador</a>
				</div>
			</div>
			<div id="navbar" class="navbar-collapse collapse">
				...
				<ul class="nav navbar-nav navbar-right">
					<li><a href="AdminHomeServlet"><span
	...
	<div class="container">
		...
		<div class="col-md-12">
			...
			<form action="AdvanceStatus" method="POST">
				<div class="button">
					<button type="submit" class="btn btn-primary btn-lg">Avanzar
						fase</button>
				</div>
			</form>
			</p>
